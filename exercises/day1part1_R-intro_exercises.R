...
is.na(vec)
sum(is.na(vec))
mean(is.na(vec))   ##proportion of missing values
#### Factors ####
...
lifeexp_mean <- mean(gapminder07$lifeExp)
gapminder07$lifeExp_highlow <- NA
gapminder07$lifeExp_highlow[gapminder07$lifeExp > lifeexp_mean] = 'High'
gapminder07$lifeExp_highlow[gapminder07$lifeExp < lifeexp_mean] = 'Low'
